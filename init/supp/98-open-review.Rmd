...
Open Review means that you can freely read this volume and easily help to make it better. You can offer suggestions by making annotations using [hypothes.is](https://hypothes.is/), an open source annotation system. This is a simple system for interacting with this volume. If you are familiar with GitHub or Git, you can also comment using [GitHub's issue tracker](https://github.com/aksel-blaise/dalton/issues) for the volume, or make a pull request. In addition to these feedback options, this website for the book will be collecting your implicit feedback by tracking the readership and abandonment rate of each section.
...
Yes, all annotations are public. You can view them on right side of the each page.
...
Absolutely. View the code for this website at <https://github.com/aksel-blaise/dalton> for more about how we did it.
...
The bulk of the (modified) text above comes from [Ben Marwick's](https://github.com/benmarwick/bookdown-ort) bookdown example that illustrates how each of the pieces of this volume function independently, and as a whole. Many thanks to Ben for making this available, and I encourage other archaeologists to make use of these tools.
