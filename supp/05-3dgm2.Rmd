# 3DGM without sLMs 12 and 13

## Load packages + data

```{r load.data.2, echo = TRUE}
# load packages
...
```{r gpa.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# gpa
...
gdf <- geomorph.data.frame(shape = Y.gpa$coords, size = Y.gpa$Csize, 
                           ...
                           bev.1 = qdata$bev, bev.2 = qdata$bev.type)
```

```{r consensus.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="2D plot of 3D consensus configuration."}
...
```{r 3d.gpa.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Results of generalized Procrustes analysis."}
# render 3d gpa plot
#plot(Y.gpa)
...
```{r box.attr.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# add centroid size to qdata
qdata$csz <- Y.gpa$Csize

# print updated qdata with centroid size
knitr::kable(qdata, align = "ccccc", caption = "Modified attributes included in qdata.")
...
```{r box1.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap = "Boxplot of centroid size by Heartland (in/out)."}
...
```{r box2.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap = "Boxplot of centroid size by Heartland region."}
...
```{r box3.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap = "Boxplot of centroid size by beveled."}
...
```{r box4.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap = "Boxplot of centroid size by bevel type."}
...
```{r pca.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# principal components analysis
...
```{r allom.dalton.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# allometry
fit.size <- procD.lm(shape ~ size, data = gdf, 
                     print.progress = FALSE, iter = 9999)
# allometry - common allometry, different means -> heart
fit.sz.cinc <- procD.lm(shape ~ size + heart, data = gdf, 
                        print.progress = FALSE, iter = 9999)
# allometry - unique allometries -> heart
fit.sz.uinc <- procD.lm(shape ~ size * heart, data = gdf, 
                        print.progress = FALSE, iter = 9999)
# allometry - common allometry, different means -> hreg
fit.sz.cinc2 <- procD.lm(shape ~ size + hreg, data = gdf, 
                         print.progress = FALSE, iter = 9999)
# allometry - unique allometries -> hreg
fit.sz.uinc2 <- procD.lm(shape ~ size * hreg, data = gdf, 
                         print.progress = FALSE, iter = 9999)
```

### Hypothesis 1

```{r def.mod.1.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
## Define models
...
```{r def.mod.2.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
## Define models
...
```{r def.mod.3.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
## Define models
...
```{r def.mod.4.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
## Define models
...
```{r allometryEX.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r common.all.ex.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# inc
...
```{r allom.plot1.ex.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# allometry plots
# regscore (Drake and Klingenberg 2008)
plot(fit.size, type = "regression", reg.type = "RegScore", 
     predictor = log(gdf$size), pch = pch.gps.heart, col = col.gps.heart)
plot(fit.size, type = "regression", reg.type = "RegScore", 
     predictor = log(gdf$size), pch = pch.gps.hreg, col = col.gps.hreg)
```

```{r allom.plot2.ex.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# common allometric component (Mitteroecker 2004)
plotAllometry(fit.size, size = gdf$size, logsz = TRUE, method = "CAC", 
              pch = pch.gps.heart, col = col.gps.heart)
plotAllometry(fit.size, size = gdf$size, logsz = TRUE, method = "CAC", 
              pch = pch.gps.hreg, col = col.gps.hreg)
```

```{r allom.plot3.ex.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r unique.all.ex.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
# heart
anova(fit.sz.uinc) # unique allometry (heart)

# hreg
anova(fit.sz.uinc2) # unique allometry (hreg)
```

```{r unique.allom.plot.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r lm3d3.a1.h1.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Hypothesis 1 considers whether Dalton points discovered in (left) and out (right) of the Heartland differ in morphology."}
knitr::include_graphics('images/dalton-vizhypothesis1.jpg')
```

```{r h1.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r lm3d3.a1.h2.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Hypothesis 2 considers whether Dalton points discovered in the heartland (left), interior (center), and northern periphery (right) differ in morphology."}
knitr::include_graphics('images/dalton-vizhypothesis2.jpg')
```

```{r h2.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r lm3d3.a1.h3.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Hypothesis 3 considers whether beveled Dalton points (left) differ in morphology from those that are not beveled (right)."}
knitr::include_graphics('images/dalton-vizhypothesis3.jpg')
```

```{r h3.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
...
```{r lm3d3.a1.h4.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Hypothesis 4 considers whether discrete beveling practices articulate with differences in the morphology of Dalton points"}
knitr::include_graphics('images/dalton-vizhypothesis4-1.jpg')
```

```{r h4.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE}
