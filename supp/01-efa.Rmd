...
Prior to running the full 3D geometric morphometric (3DGM) analysis, an elliptic Fourier analysis was conducted to identify differences in Dalton projectile point shape in plan view. These data were employed to inform the subsequent landmarking protocol used for the 3DGM analysis.

Those 2D images (jpegs) used in the EFA were generated as screen captures of the 3D dataset, and are oriented with the same base alignment. Each image was masked in Photoshop to render a binary (black/white) image.
