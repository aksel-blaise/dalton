...
pc.plot1 <- plot(pca, 
  ...
  pc <- pca$x[,1] # x-axis
  preds <- shape.predictor(Y.gpa$coords, 
...
fit.sz.cinc <- procD.lm(shape ~ size + heart, 
                        data = gdf, 
                        print.progress = FALSE, 
                        iter = 9999)
# allometry - unique allometries -> heart
fit.sz.uinc <- procD.lm(shape ~ size * heart, 
                        data = gdf, 
                        print.progress = FALSE, 
                        iter = 9999)
# allometry - common allometry, different means -> hreg
fit.sz.cinc2 <- procD.lm(shape ~ size + hreg, 
                         data = gdf, 
                         print.progress = FALSE, 
                         iter = 9999)
# allometry - unique allometries -> hreg
fit.sz.uinc2 <- procD.lm(shape ~ size * hreg, 
                         data = gdf, 
                         print.progress = FALSE, 
                         iter = 9999)
```
