...
```{r figspline, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Spline extracted along the highest contours of the Dalton point."}
...
```{r figcurve2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Identify points of hightest curvature (light blue) at left/right intersection of blade and base."}
...
```{r figsplinesplit-frbl, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Result of spline splits include six discrete splines, each articulating with a region of analytical interest."}
knitr::include_graphics('images/splinesplit-frbl.png')
```

## Landmark and semilandmark placement

Landmarks 1 - 6 were placed at the location of each spline split (blue points, below). Equidistant semilandmarks were added to each of the four splines; 10 between LM1 and LM4, three between LM4 and LM2, three between LM2 and LM6, three between LM6 and LM3, three between LM3 and LM5, and 10 between LM5 and LM1.

```{r figlmslm-all, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="Mesh with landmarks (blue) and equidistant semilandmarks (white) applied."}
