...
The second `reference plane` (ref.pl.3) was placed between ref.pt.0 and LM 06, bisecting the base of the projectile along the mid-line. The method of placement for ref.pl.2 follows the same protocol described in the application of ref.pl.1, and the `reference point` (ref.pt.2) was deleted following the placement of ref.pl.3.
...
```{r lm3d3.ref.pl.2, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="_**Figure 13. Placement of ref.pl.3, and temporary location of ref.pt.3.**_"}
