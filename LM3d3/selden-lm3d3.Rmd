...
```{r lm3d3.figsplinesplit-frbl, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="_**Figure 10. Result of spline splits include six discrete splines, each articulating with a region of analytical interest.**_"}
...
```{r lm3d3.vectors, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="_**Figure 11. Reference vectors placed between LMs 01 and 06 (left), and between LMs 04 and 05 (right).**_"}
...
```{r lm3d3.ref.pl.1, out.width = "100%", dpi = 300, echo=TRUE, warning=FALSE, fig.cap="_**Figure 12. Placement of ref.pl.1, and location of ref.pt.1.**_"}
