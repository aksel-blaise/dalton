...
Based upon knowledge garnered from running `LaSEC` on LM3d1, this landmarking protocol would likely oversampled if it included additional landmarks on the cross-sections; however, it can be readily modified to include as many or as few landmarks and semilandmarks needed to address the research question. 
