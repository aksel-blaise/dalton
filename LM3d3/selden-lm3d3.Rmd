...
Like its' predecessors, LM3d3 was initially designed using the [`digit3DLand`]((https://github.com/morphOptics/digit3DLand)) package in R. When the draft protocol was complete, protocol design was shifted to Geomagic Design X _(Build Version 2020.0.1 [Build Number: 30])_, where the workflow was modified to include those elements of `reference geometry` that articulate with the specific design attributes of each point.
