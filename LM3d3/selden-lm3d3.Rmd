...
LM3d3: Configuration 1 (LM3d3:c1) was used in the analysis of the first three hypotheses. Semilandmarks 07 - 18 were first applied around the lateral edges, and sLMs 12 and 13 between LMs 02, 06, and 03 uses the curve constructed in [LM3d1](https://github.com/aksel-blaise/gahaganmorph2/blob/master/analysis/landmarking-protocol.md). Semilandmarks 19 - 30 articulate with the mid-line between LMs 01 and 06. Additional sLMs can be placed on each section equidistant between those sLMs defined by the splits described above to better characterise each cross section, if needed.
